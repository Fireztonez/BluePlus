...
function blue_plus_styles() {
    ...
    wp_enqueue_style( 'bluebe-plus-style', get_stylesheet_directory_uri() . '/assets/css/bpstyle.css');
    wp_enqueue_script( 'blue-plus-main-js', get_stylesheet_directory_uri() . '/assets/js/main.js');
}
